      ...
      <div className="container pt-24 pb-16">
        <Tabs defaultValue="dashboard" className="space-y-6">
          <TabsList className="bg-secondary flex-wrap h-auto gap-1 p-1">
            <TabsTrigger value="dashboard" className="font-mono text-xs">
            ...
            <TabsTrigger value="certifications" className="font-mono text-xs">
              <Award className="h-3 w-3 mr-1" /> Certifications
            </TabsTrigger>
            <TabsTrigger value="domains" className="font-mono text-xs">
              <Layers className="h-3 w-3 mr-1" /> Domains
            </TabsTrigger>
            <TabsTrigger value="tags" className="font-mono text-xs">
              <Tag className="h-3 w-3 mr-1" /> Tags
            </TabsTrigger>
            <TabsTrigger value="badges" className="font-mono text-xs">
              <BookOpen className="h-3 w-3 mr-1" /> Badges
            </TabsTrigger>
            <TabsTrigger value="exams" className="font-mono text-xs">
              <ClipboardList className="h-3 w-3 mr-1" /> Exams
            </TabsTrigger>
            <TabsTrigger value="organizations" className="font-mono text-xs">
            ...
            <TabsTrigger value="reports" className="font-mono text-xs">
              <AlertTriangle className="h-3 w-3 mr-1" /> Reports
            </TabsTrigger>
            <TabsTrigger value="audit" className="font-mono text-xs">
              <ScrollText className="h-3 w-3 mr-1" /> Audit Log
            </TabsTrigger>
