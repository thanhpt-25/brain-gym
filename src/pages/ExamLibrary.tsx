...
import { Clock, FileText, Loader2, Plus, Users, Play, TrendingUp, Copy, Check } from 'lucide-react';
...
const ExamLibrary = () => {
  ...
  const {
    ...
    queryFn: ({ pageParam = 1 }) => getExams(certId || undefined, pageParam, 12, sort),
    initialPageParam: 1,
      ...
      <section className="pt-24 pb-20">
        <div className="container max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3 mb-6">
            <Select value={certId || 'all'} onValueChange={v => setCertId(v === 'all' ? '' : v)}>
            ...
            <>
              ...
              <div ref={sentinelRef} className="py-12 flex justify-center">
                ...
                {!hasNextPage && exams.length > 0 && (
                  <p className="text-xs text-muted-foreground font-mono opacity-50">All exams loaded</p>
                )}
              </div>
            </>
          )}
