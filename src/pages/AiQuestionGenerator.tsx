      ...
      <div className="container max-w-5xl mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">
            Upload study materials, generate exam questions with your AI key,
            and auto-publish high-quality ones to the question bank.
          </p>
        </div>
          ...
          <TabsList className="mb-6">
            ...
            {generationResult && (
              <TabsTrigger value="review">
                Review ({generationResult.result.questions?.length ?? 0})
              </TabsTrigger>
            )}
          ...
          <TabsContent value="settings">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Brain Gym uses a Bring Your Own Key (BYOK) model. Your API
