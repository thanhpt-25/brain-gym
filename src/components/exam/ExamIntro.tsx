...
import { ChevronLeft, Brain, Zap, Clock, Coffee } from 'lucide-react';
...
const TIMER_MODES: { value: TimerMode; label: string; description: string; icon: React.ReactNode; color: string }[] = [
  {
    value: 'RELAXED',
    label: 'Relaxed',
...
export function ExamIntro({ cert, questionCount, timerMode, onTimerModeChange, onBack, onStart }: ExamIntroProps) {
  const effectiveTimeLimit = timerMode === 'ACCELERATED' ? Math.round(130 * 0.75) : 130;
      ...
      <div className="container max-w-2xl py-20">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass-card p-8">
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            ...
            <div className="text-center p-3 rounded-lg bg-secondary">
              <div className="text-xl font-mono font-bold text-foreground">{effectiveTimeLimit}m</div>
          ...
          {/* Timer Mode Selector */}
          <div className="mb-6">
            <div className="text-sm font-mono font-semibold mb-2">Timer Mode</div>
