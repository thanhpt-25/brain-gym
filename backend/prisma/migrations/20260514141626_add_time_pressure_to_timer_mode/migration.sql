...
-- DropForeignKey
-- Note: These foreign keys should already exist from migration 20260505062031_add_preview_data_to_job
-- but dropping them because they need to be re-added with ON UPDATE CASCADE instead of ON UPDATE CASCADE
...
-- Note: All the following indices were already created in migration 20260505062031_add_preview_data_to_job:
-- flashcard_review_schedules_user_id_next_review_date_idx
-- flashcard_review_schedules_user_id_mastery_idx
-- questions_deleted_at_idx
-- questions_status_idx
-- questions_certification_id_status_idx
-- users_status_idx
