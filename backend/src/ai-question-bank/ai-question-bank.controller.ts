...
export class AiQuestionBankController {
  ...
  @ApiOperation({
    summary:
      'Upload a study material (text or URL). For PDF use /materials/pdf',
  })
  uploadTextMaterial(
    @Req() req: AuthenticatedRequest,
  ...
  @ApiOperation({
    summary:
      'Generate questions from source material (returns preview, not saved)',
  })
  generateQuestions(
    @Req() req: AuthenticatedRequest,
    @Body() dto: GenerateQuestionsDto,
  ...
  @Post('save')
  @ApiOperation({
    summary: 'Save selected generated questions to the question bank',
  })
  saveGeneratedQuestions(
    @Req() req: AuthenticatedRequest,
    @Body() dto: SaveGeneratedQuestionsDto,
  ) {
