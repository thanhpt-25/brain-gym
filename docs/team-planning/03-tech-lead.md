...
| RFC-007 | pgvector Setup + Semantic Dedup        | Embedding cho Question để chống duplicate khi LLM generate, làm nền cho Knowledge Graph.                                                  | AI Lead           | 2026-06-15 | RFC-004          | Accepted |
...
| RFC-010 | Dynamic Difficulty Scaling Spec        | LLM rewrite distractors khi user mastery cao. Cần audit trail + rollback.                                                                 | AI Lead           | 2026-07-15 | RFC-007          | Accepted |
